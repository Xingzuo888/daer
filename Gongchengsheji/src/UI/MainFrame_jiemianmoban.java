...
public class MainFrame_jiemianmoban extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MainFrame_jiemianmoban frame = new MainFrame_jiemianmoban();
	...
	public MainFrame_jiemianmoban() {
		...
		mntmNewMenuItem_borrowbook.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				JLabel lblNewLabel = new JLabel("请输入读者的编号");
				lblNewLabel.setHorizontalAlignment(SwingConstants.CENTER);
				lblNewLabel.setFont(new Font("宋体", Font.PLAIN, 18));
				...
				JLabel lblNewLabel_3 = new JLabel("请输入书的编号");
