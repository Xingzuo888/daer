...
class Tax{
	...
	int[][] brackets = {
			...
			{8350,33950,68525,104425,168475},   //Married separately
	...
	public int getMarriedJointlyOrQualifyingWidow() {
		return MARRIED_JOINTLY_OR_QUALIFYING_WIDOW;
	}
	public int getMarriedSeparately() {
